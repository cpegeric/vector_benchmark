...
Measure search performance. Data can be generated in blocks on-the-fly or read from a CSV file. Data generation is done asynchronously in the background to minimize blocking and improve performance in multi-threaded tests.
```bash
