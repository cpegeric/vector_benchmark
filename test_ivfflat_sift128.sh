...
echo "--- Normal Mode ---"
python3 recall.py -f $CONFIG -m normal -n 100 -t 4 -i $CSV_FILE
echo "--- Pre-filtering Mode ---"
python3 recall.py -f $CONFIG -m prefilter -n 100 -t 4 --i32v 500 -i $CSV_FILE
echo "--- Post-filtering Mode ---"
python3 recall.py -f $CONFIG -m post -n 100 -t 4 --i32v 500 -i $CSV_FILE
